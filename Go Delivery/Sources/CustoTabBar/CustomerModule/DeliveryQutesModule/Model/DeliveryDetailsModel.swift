...
class DeliveryDetailsModel: NSObject {
    ...
    var strisReviewRequested : String = ""
    ...
    var strCarNumber : String = ""
    var strCarColor : String = ""
    var strCarMake : String = ""
    ...
    init(dict : [String : Any]) {
        if let dictUser = dict["delivery_detail"]as? [String:Any]{
            ...
            if let vehicleInformation = dictUser["vehicle_information"] as? [String:Any]{
                if let carMake = vehicleInformation["make"] as? String{
                    self.strCarMake = carMake
                }
                if let carModel = vehicleInformation["model"] as? String{
                    self.strCarModel = carModel
                }
                if let carNumber = vehicleInformation["plate_number"] as? String{
                    self.strCarNumber = carNumber
                }
                if let carColor = vehicleInformation["color"] as? String{
                    self.strCarColor = carColor
                }
            }
            ...
            if let is_review_requested = dictUser["is_review_requested"]as? String{
                           strisReviewRequested = is_review_requested
                       }else if let is_review_requested = dictUser["is_review_requested"]as? Int{
                           strisReviewRequested = String(is_review_requested)
            }else {
                        strisReviewRequested = ""
            ...
            if let dicR = dictUser["review"]as? [String:Any]{
                ...
                strReviewGiven = "0"
                  ...
                  if let dictUser = dictUser["quote_list"]as? [String:Any]{
